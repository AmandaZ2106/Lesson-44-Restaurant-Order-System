...
class RestaurantOrderManagement:
    ...
    def setup_background(self, root):
        ...
        self.canvas = tk.Canvas(root, width=bg_width, height=bg_height)
        self.canvas.pack()

        self.original_image = tk.PhotoImage(file="restaurant_background.png")
        self.background_image = self.original_image.subsample(
            max(1, self.original_image.width() // bg_width),
            max(1, self.original_image.height() // bg_height)
        )
